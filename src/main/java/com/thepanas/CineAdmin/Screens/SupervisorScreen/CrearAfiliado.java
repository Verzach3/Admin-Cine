...
public class CrearAfiliado extends JPanel implements MouseListener {
    ...
    public CrearAfiliado(Main mainFrame) {
        ...
        titleLabel.setText("CREAR USUARIO AFILIADO");
            ...
            if (!user.getNickName().equals(userName.getText().trim())) {
                if (!nameField.getText().equals("") || !userName.getText().equals("") || !passWord.getText().equals("") || !confirmPassWord.getText().equals("")) {
                    ...
                    if (passWord.getText().equals(confirmPassWord.getText())) {
                        ...
                        MakeDialog.makeInfoDialog("Usuario Afiliado Creado Correctamente","");
                        nameField.setText("");
                        userName.setText("");
                        passWord.setText("");
